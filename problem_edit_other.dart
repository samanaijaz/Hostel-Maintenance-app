...
class problemeditor_other extends StatefulWidget {

  @override
  State<problemeditor_other> createState() => _problemeditor_other();
}

class _problemeditor_other extends State<problemeditor_other> {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          FirebaseFirestore.instance.collection("other problems").add({
