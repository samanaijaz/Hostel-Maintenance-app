...
class problemeditor_clean extends StatefulWidget {



  @override
  State<problemeditor_clean> createState() => _problemeditor_clean();
}

class _problemeditor_clean extends State<problemeditor_clean> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          FirebaseFirestore.instance.collection("cleaning problems").add({
    ...
    //     final user=await GoogleAuthProvider.signIn();
    //     final email='1205adnanahmad@gmail.com';
    //     final token= '';
    //     final smtpServer= gmailSaslXoauth2(email,token);
    //
    //
    //     final message = Message()
    //       ..from = Address(email,'john')
    //       ..recipients=['1205adnanahmad@gmail.com']
    //       ..subject='hello john'
