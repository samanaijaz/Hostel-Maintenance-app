...
class problemeditor_leave extends StatefulWidget {

  @override
  State<problemeditor_leave> createState() => _problemeditor_leave();
}

class _problemeditor_leave extends State<problemeditor_leave> {
  int color_id = 4;
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () async {
          ...
          FirebaseFirestore.instance.collection("leave problem").add({
